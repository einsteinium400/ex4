var LocalEchoController = function (t) {
    ...
    r.quote = function (t) {
        return i(t, function (t) {
            return t && "object" == typeof t ? t.op.replace(/(.)/g, "\\$1") : /["\s]/.test(t) && !/'/.test(t) ? "'" + t.replace(/(['\\])/g, "\\$1") + "'" : /["'\s]/.test(t) ? '"' + t.replace(/(["\\$`!])/g, "\\$1") + '"' : String(t).replace(/([#!"$&'()*,:;<=>?@\[\\\]^`{|}])/g, "\\$1")
        }).join(" ")
    };
    for (var u = "(?:" + ["\\|\\|", "\\&\\&", ";;", "\\|\\&", "[&;()|<>]"].join("|") + ")", a = "(\\\\['\"|&;()<> \\t]|[^\\s'\"|&;()<> \\t])+", c = '"((\\\\"|[^"])*?)"', h = "'((\\\\'|[^'])*?)'", l = "", f = 0; f < 4; f++) l += (Math.pow(16, 8) * Math.random()).toString(16);
    r.parse = function (t, r, e) {
        var f = function (t, r, e) {
            ...
            return i(f, function (t, i) {
                if (!p) {
                    if (RegExp("^" + u + "$").test(t)) return {
                        op: t
                    };
                    for (var s = e.escape || "\\", o = !1, a = !1, c = "", h = !1, v = 0, m = t.length; v < m; v++) {
                        var y = t.charAt(v);
                        if (h = h || !o && ("*" === y || "?" === y), a) c += y, a = !1;
                        else if (o) y === o ? o = !1 : "'" == o ? c += y : y === s ? (v += 1, y = t.charAt(v), c += '"' === y || y === s || "$" === y ? y : s + y) : c += "$" === y ? d() : y;
                        else if ('"' === y || "'" === y) o = y;
                        else {
                            if (RegExp("^" + u + "$").test(y)) return {
                                op: t
                            };
                            if (RegExp("^#$").test(y)) return p = !0, c.length ? [c, {
        ...
        return "function" != typeof r ? f : o(f, function (t, r) {
            if ("object" == typeof r) return t.concat(r);
            var e = r.split(RegExp("(" + l + ".*?" + l + ")", "g"));
            return 1 === e.length ? t.concat(e[0]) : t.concat(i(s(e, Boolean), function (t) {
    ...
    s = function () {
            ...
            case "{":
                return function () {
                    ...
                    if ("{" === n) {
                        if (a("{"), l(), "}" === n) return a("}"), r;
                        for (; n;) {
                            if (t = h(), l(), a(":"), Object.hasOwnProperty.call(r, t) && u('Duplicate key "' + t + '"'), r[t] = s(), l(), "}" === n) return a("}"), r;
                            a(","), l()
                        }
                    }
                    u("Bad object")
        ...
        var o;
        return i = t, e = 0, n = " ", o = s(), l(), n && u("Syntax error"), "function" == typeof r ? function t(e, n) {
            var i, s, o = e[n];
            if (o && "object" == typeof o)
                for (i in o) Object.prototype.hasOwnProperty.call(o, i) && (void 0 !== (s = t(o, i)) ? o[i] = s : delete o[i]);
            return r.call(e, n, o)
        }({
            "": o
        }, "") : o
    ...
    var e, n, i, s = /[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
        o = {
            "\b": "\\b",
            "\t": "\\t",
            "\n": "\\n",
    ...
    t.exports = function (t, r, s) {
        ...
        return function t(r, s) {
            var o, a, c, h, l, f = e,
                p = s[r];
            switch (p && "object" == typeof p && "function" == typeof p.toJSON && (p = p.toJSON(r)), "function" == typeof i && (p = i.call(s, r, p)), typeof p) {
                case "string":
                    return u(p);
                case "number":
                ...
                case "object":
                    ...
                    if (i && "object" == typeof i)
                        for (h = i.length, o = 0; o < h; o += 1) "string" == typeof (a = i[o]) && (c = t(a, p)) && l.push(u(a) + (e ? ": " : ":") + c);
                    else
                        for (a in p) Object.prototype.hasOwnProperty.call(p, a) && (c = t(a, p)) && l.push(u(a) + (e ? ": " : ":") + c);
                    return c = 0 === l.length ? "{}" : e ? "{\n" + e + l.join(",\n" + e) + "\n" + f + "}" : "{" + l.join(",") + "}", e = f, c
            }
        }("", {
            "": t
    ...
    var i = function () {
            function t(r) {
                ...
                }(this, t), this.size = r, this.entries = [], this.cursor = 0
            }
            return function (t, r, e) {
                ...
                key: "push",
                value: function (t) {
                    "" !== t.trim() && (t != this.entries[this.entries.length - 1] && (this.entries.push(t), this.entries.length > this.size && this.entries.pop(0), this.cursor = this.entries.length))
                }
            }, {
                key: "rewind",
                value: function () {
    ...
    function u(t) {
        for (var r, e = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1], n = [], i = /\w+/g; r = i.exec(t);) e ? n.push(r.index) : n.push(r.index + r[0].length);
        return n
    }

    function a(t, r) {
        var e = u(t, !0).reverse().find(function (t) {
            return t < r
        });
        return null == e ? 0 : e
    }
    ...
    var p = function () {
        function t(r) {
            ...
            ! function (t, r) {
                if (!(t instanceof r)) throw new TypeError("Cannot call a class as a function")
            }(this, t), this.term = r, this.term.on("data", this.handleTermData.bind(this)), this.term.on("resize", this.handleTermResize.bind(this)), this.history = new i(e.historySize || 10), this.maxAutocompleteEntries = e.maxAutocompleteEntries || 100, this._autocompleteHandlers = [], this._active = !1, this._input = "", this._cursor = 0, this._activePrompt = null, this._activeCharPrompt = null, this._termSize = {
                cols: this.term.cols,
                rows: this.term.rows
            }
        }
        return function (t, r, e) {
            ...
            key: "read",
            value: function (t, prefix) {
                var r = this,
                    e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "> ";
                return new Promise(function (n, i) {
                    r.term.write(t), r._activePrompt = {
                        prompt: prefix+t,
                        continuationPrompt: e,
                        resolve: n,
                        reject: i
                    }, r._input = "", r._cursor = 0, r._active = !0
                })
            }
        }, {
            key: "continue",
            value: function (t, prefix, html) {
            }
        }, {
            key: "readChar",
            value: function (t) {
                ...
                return new Promise(function (e, n) {
                    r.term.write(t), r._activeCharPrompt = {
                        prompt: t,
                        resolve: e,
                        reject: n
                    }
            ...
            value: function (t) {
                ...
                for (var e = t.reduce(function (t, r) {
                        return Math.max(t, r.length)
                    }, 0) + r, n = Math.floor(this._termSize.cols / e), i = Math.ceil(t.length / n), s = 0, o = 0; o < i; ++o) {
                    for (var u = "", a = 0; a < n; ++a)
                        if (s < t.length) {
                            var c = t[s++];
            ...
            key: "clearInput",
            value: function () {
                for (var t = this.applyPrompts(this._input), r = h(t, this._termSize.cols), e = c(t, this.applyPromptOffset(this._input, this._cursor), this._termSize.cols), n = (e.col, r - e.row - 1), i = 0; i < n; ++i) term.write("[E");
                term.write("\r[K");
            ...
            value: function (t) {
                ...
                var r = this.applyPrompts(this._input),
                    e = (h(r, this._termSize.cols), c(r, this.applyPromptOffset(this._input, this._cursor), this._termSize.cols)),
                    n = e.col,
                    i = e.row,
                    ...
                    u = s.row;
                if (u > i)
                    for (var a = i; a < u; ++a) term.write("[B");
                else
                    for (var l = u; l < i; ++l) term.write("[A");
                if (o > n)
                    for (var f = n; f < o; ++f) term.write("[C");
                else
                    for (var p = o; p < n; ++p) term.write("[D");
                this._cursor = t
            }
        }, {
            ...
            value: function (t) {
                var r = t.rows,
                    e = t.cols;
                this.clearInput(), this._termSize = {
                    cols: e,
                    rows: r
            ...
            value: function (t) {
                var r = this;
                if (this._active) {
                    var e, n = t.charCodeAt(0);
                    if (27 == n) switch (t.substr(1)) {
                        case "[A":
                            if (this.history) {
                        ...
                        case "f":
                            ...
                            break;
                        case "":
                            null != (e = a(this._input, this._cursor)) && (this.setInput(this._input.substr(0, e) + this._input.substr(this._cursor)), this.setCursor(e))
                    } else if (n < 32 || 127 === n) switch (t) {
                        case "\r":
                            ! function (t) {
                        ...
                        case "\t":
                            if (this._autocompleteHandlers.length > 0) {
                                var h = this._input.substr(0, this._cursor),
                                    ...
                                    p = function (t, r) {
                                        var e = Object(s.parse)(r),
                                            n = e.length - 1,
                                            i = e[n] || "";
                                        return "" === r.trim() ? (n = 0, i = "") : l(r) && (n += 1, i = ""), t.reduce(function (t, r) {
                                            var i = r.fn,
                                                s = r.args;
                                            try {
                                ...
                                } else p.length <= this.maxAutocompleteEntries ? this.printAndRestartPrompt(function () {
                                    r.printWide(p)
                                }) : this.printAndRestartPrompt(function () {
                                    return r.readChar("Display all ".concat(p.length, " possibilities? (y or n)")).then(function (t) {
