    ...
    e.parse = function (t, e, n) {
        var s = function (t, e, n) {
            ...
            return o.map((function (t, s) {
                if (!a) {
                    if (RegExp("^" + r + "$").test(t)) return {
                        op: t
                    };
                    for (var u = n.escape || "\\", h = !1, l = !1, c = "", p = !1, f = 0, v = t.length; f < v; f++) {
                        var m = t.charAt(f);
                        if (p = p || !h && ("*" === m || "?" === m), l) c += m, l = !1;
                        else if (h) m === h ? h = !1 : "'" == h ? c += m : m === u ? (f += 1, c += '"' === (m = t.charAt(f)) || m === u || "$" === m ? m : u + m) : c += "$" === m ? d() : m;
                        else if ('"' === m || "'" === m) h = m;
                        else {
                            if (RegExp("^" + r + "$").test(m)) return {
                                op: t
                            };
                            if (RegExp("^#$").test(m)) return a = !0, c.length ? [c, {
                                comment: t.slice(f + 1) + o.slice(s + 1).join(" ")
                            }] : [{
                                comment: t.slice(f + 1) + o.slice(s + 1).join(" ")
                            }];
                            m === u ? l = !0 : c += "$" === m ? d() : m
        ...
        return e = t, (r = [{
            ...
            value: function (t) {
                ...
                return new Promise((function (r, i) {
                    e.term.write(t), e._activeCharPrompt = {
                        prompt: t,
                        resolve: r,
                        reject: i
                    }
            ...
            value: function (t) {
                ...
                var i = this.applyPromptOffset(t, this._cursor),
                    n = c(r, this._termSize.cols),
                    s = l(r, i, this._termSize.cols),
                    o = s.col,
                    a = s.row,
                    u = n - a - 1;
                this.term.write("\r");
            ...
            value: function (t) {
                ...
                var e = this.applyPrompts(this._input),
                    ...
                    i = r.col,
                    n = r.row,
                    s = l(e, this.applyPromptOffset(this._input, t), this._termSize.cols),
                    o = s.col,
                    a = s.row;
                if (a > n)
                    for (var u = n; u < a; ++u) this.term.write("[B");
                else
                    for (var h = a; h < n; ++h) this.term.write("[A");
                if (o > i)
                    for (var p = i; p < o; ++p) this.term.write("[C");
                else
                    for (var f = o; f < i; ++f) this.term.write("[D");
                this._cursor = t
            }
        }, {
                    ...
                    if (27 == l) switch (t.substr(1)) {
                        ...
                        case "\t":
                            if (this._autocompleteHandlers.length > 0) {
                                var m = this._input.substr(0, this._cursor),
                                    d = p(m),
                                    _ = function (t, e) {
                                        var r = Object(s.parse)(e),
                                            i = r.length - 1,
                                            n = r[i] || "";
                                ...
                                if (_.sort(), 0 === _.length) d || this.handleCursorInsert(" ");
                                else if (1 === _.length) {
                                    var g = f(m);
