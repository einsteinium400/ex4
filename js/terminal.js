...
var questions = [{
    ...
    "form_id": "nickname",
    "formValue": "value",
    "wronginput": "! Invalid Input: name must include letters from a-z only and a space"
}, {
    //PASSWORD
...
},
{
    ...
    "type": "checkbox",
    "formClass": "checkbox",
    "wronginput": "at least one must be checked"
},
{
...
var custom_question = async function (question) {
    ...
    if (question.type == "checkbox") {
        ...
        var sum = 0;
        for (var ischeck of document.getElementsByClassName("checkbox")) {
...
window.onload = async () => {
    ...
    term.clear();
    await showText("~$ !@#$%^&*!@#$%^&*^%$#@!*&^%$#@! \r\n Hacking using your information now..", 0, writeSpeed);
